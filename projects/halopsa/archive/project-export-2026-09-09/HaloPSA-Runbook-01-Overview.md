...
>
> **How to use this:** This file is meant to live in the **"HaloPSA" Claude Project**
> knowledge. Any chat started inside that project will have this context automatically.
> This is runbook **#01 (overview)** — add more focused runbooks to the same project as
> new workflows are learned (see "Adding more runbooks" at the end).
>
...
1. **Small addition** → write it back into the relevant section of the appropriate runbook
   in this project (and bump that file's "Last updated" date).
2. **New area/workflow** → create a **new focused runbook** (`HaloPSA-Runbook-NN-*.md`) in
   this same project and add it to the index in §9.
...
> `claude/HaloPSA-MCP-Capability-Review-2026-08-12.md`.
...
- **02 — `claude/HaloPSA-Runbook-02-Quotations-Lines-Groups.md`** — building quote content:
...
- **03 — `claude/HaloPSA-Runbook-03-Email-Templates.md`** — email templates: config URLs
...
- **04 — `claude/HaloPSA-Runbook-04-Notifications.md`** — agent notification rules: config
  ...
  in `claude/HaloPSA-Notifications-Audit-2026-07-17.md`.
- **05 — `claude/HaloPSA-Runbook-05-PDF-Templates-SO-PO-Invoice.md`** — the Simvay-branded
...
- **06 — `claude/HaloPSA-Runbook-06-Client-Portal.md`** — the client-facing self-service
...
- **07 — `claude/HaloPSA-Runbook-07-Travel-Notifications.md`** — the **User Travel**
...
- **08 — `claude/HaloPSA-Runbook-08-Action1-Ticket-Type-Routing.md`** — Action1 RMM →
...
- **09 — `claude/HaloPSA-Runbook-09-Claude-Access-Architecture.md`** — decision record +
...
- **10 — `claude/HaloPSA-Runbook-10-Reporting-SQL.md`** — reporting & custom SQL reports:
...
- **11 — `claude/HaloPSA-Runbook-11-Action1-Renewal-Quotes.md`** — **Action1 (A1)
...
- **12 — `claude/HaloPSA-Runbook-12-Scheduled-Tasks-Connector-Binding.md`** — why custom
...
**Other project docs:** `Runbook_Renewal_DeepDive.md` (the weekly "Weekly | Renewals" report
spec and its standing ops context), `RUNBOOK_Weekly_Ops_Retrospective.md`,
`claude/HaloPSA-MCP-Capability-Review-2026-08-12.md` (worker v1.1.0 gap review — ranked
