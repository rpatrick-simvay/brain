...
- **S-mark (zig-zag "S" with ringed ends):** white-on-transparent and
  ...
  `runbooks/simvay-logo-datauris.md`; the starter template
  (`runbooks/simvay-report-starter-template.html`) already embeds the white mark.
