---
title: "HaloPSA reference: ticket status ID map (verified 2026-08-18)"
type: reference
updated: 2026-08-18
tags: [halopsa, reference, tickets]
related: [runbooks/halopsa-01-overview, projects/halopsa/STATUS]
source: "HaloPSA Claude Project: claude/HaloPSA-Ticket-Status-ID-Map-Verified-2026-08-18.md"
migrated: 2026-09-09
---
> Migrated 2026-09-09 from the HaloPSA Claude Project (`HaloPSA-Ticket-Status-ID-Map-Verified-2026-08-18.md`). This file is now the canonical copy; the project doc is frozen. The verbatim original is in `projects/halopsa/archive/project-export-2026-09-09/`. Em and en dashes in prose were replaced per CLAUDE.md; code blocks are untouched. Cross-references were rewritten to brain paths.
