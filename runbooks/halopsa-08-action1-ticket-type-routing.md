---
title: "HaloPSA 08: Action1 ticket type, statuses and contract-based routing"
type: runbook
updated: 2026-08-04
tags: [halopsa, action1, ticket-routing]
related: [runbooks/halopsa-01-overview, projects/halopsa/STATUS]
source: "HaloPSA Claude Project: claude/HaloPSA-Runbook-08-Action1-Ticket-Type-Routing.md"
migrated: 2026-09-09
---
> Migrated 2026-09-09 from the HaloPSA Claude Project (`HaloPSA-Runbook-08-Action1-Ticket-Type-Routing.md`). This file is now the canonical copy; the project doc is frozen. The verbatim original is in `projects/halopsa/archive/project-export-2026-09-09/`. Em and en dashes in prose were replaced per CLAUDE.md; code blocks are untouched. Cross-references were rewritten to brain paths.
