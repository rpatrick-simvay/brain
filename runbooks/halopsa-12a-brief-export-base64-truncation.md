---
title: "HaloPSA 12a: Morning-brief export, the inline base64 truncation trap"
type: runbook
updated: 2026-09-04
tags: [halopsa, scheduled-tasks, morning-brief, onedrive]
related: [runbooks/halopsa-01-overview, projects/halopsa/STATUS]
source: "HaloPSA Claude Project: claude/HaloPSA-Runbook-12-Appendix-Brief-Export-Base64-Truncation.md"
migrated: 2026-09-09
---
> Migrated 2026-09-09 from the HaloPSA Claude Project (`HaloPSA-Runbook-12-Appendix-Brief-Export-Base64-Truncation.md`). This file is now the canonical copy; the project doc is frozen. The verbatim original is in `projects/halopsa/archive/project-export-2026-09-09/`. Em and en dashes in prose were replaced per CLAUDE.md; code blocks are untouched. Cross-references were rewritten to brain paths.
