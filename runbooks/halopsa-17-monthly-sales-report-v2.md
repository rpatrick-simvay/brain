---
title: "HaloPSA 17: Monthly sales report (v2 cost basis) build record"
type: runbook
updated: 2026-09-01
tags: [halopsa, reporting, sales-report]
related: [runbooks/halopsa-01-overview, projects/halopsa/STATUS]
source: "HaloPSA Claude Project: claude/HaloPSA-Runbook-17-Monthly-Sales-Report-v2.md"
migrated: 2026-09-09
---
> Migrated 2026-09-09 from the HaloPSA Claude Project (`HaloPSA-Runbook-17-Monthly-Sales-Report-v2.md`). This file is now the canonical copy; the project doc is frozen. The verbatim original is in `projects/halopsa/archive/project-export-2026-09-09/`. Em and en dashes in prose were replaced per CLAUDE.md; code blocks are untouched. Cross-references were rewritten to brain paths.
...
|---|---|
| `projects/halopsa/sales-report-v2/analyze2.py` | `scripts/analyze2.py` (supersedes `analyze.py`) |
| `projects/halopsa/sales-report-v2/render_report.py` | `scripts/render_report.py` (HTML → PDF via Playwright Chromium; `build_charts.py` / `build_pdf.py` retired) |
| `projects/halopsa/sales-report-v2/config.json` | `config.json` |
