---
title: "HaloPSA 12: Scheduled tasks and MCP connector binding"
type: runbook
updated: 2026-09-02
tags: [halopsa, scheduled-tasks, mcp-connector, morning-brief]
related: [runbooks/halopsa-01-overview, projects/halopsa/STATUS]
source: "HaloPSA Claude Project: claude/HaloPSA-Runbook-12-Scheduled-Tasks-Connector-Binding.md"
migrated: 2026-09-09
---
> Migrated 2026-09-09 from the HaloPSA Claude Project (`HaloPSA-Runbook-12-Scheduled-Tasks-Connector-Binding.md`). This file is now the canonical copy; the project doc is frozen. The verbatim original is in `projects/halopsa/archive/project-export-2026-09-09/`. Em and en dashes in prose were replaced per CLAUDE.md; code blocks are untouched. Cross-references were rewritten to brain paths.
...
- **THE STATUS-ID MAP IN THE MORNING-BRIEF SKILL IS STILL WRONG - re-verified 09-02, FOURTH
  ...
  **Cross-check `runbooks/halopsa-ref-ticket-status-id-map.md` - it is authoritative.**
