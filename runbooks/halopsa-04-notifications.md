---
title: "HaloPSA 04: Notifications (agent alerting)"
type: runbook
updated: 2026-08-17
tags: [halopsa, notifications, cyber-ops]
related: [runbooks/halopsa-01-overview, projects/halopsa/STATUS]
source: "HaloPSA Claude Project: claude/HaloPSA-Runbook-04-Notifications.md"
migrated: 2026-09-09
---
> Migrated 2026-09-09 from the HaloPSA Claude Project (`HaloPSA-Runbook-04-Notifications.md`). This file is now the canonical copy; the project doc is frozen. The verbatim original is in `projects/halopsa/archive/project-export-2026-09-09/`. Em and en dashes in prose were replaced per CLAUDE.md; code blocks are untouched. Cross-references were rewritten to brain paths.
...
> (`projects/halopsa/archive/HaloPSA-Notifications-Audit-2026-07-17.md`) and Runbook 03 §6.
>
